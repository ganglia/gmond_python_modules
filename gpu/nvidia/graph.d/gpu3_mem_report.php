...
function graph_gpu3_mem_report ( &$rrdtool_graph ) {
    ...
    $series = "DEF:'gpu_mem_total'='${rrd_dir}/gpu3_mem_total.rrd':'sum':AVERAGE "
        ."CDEF:'bgpu_mem_total'=gpu_mem_total,1024,* "
        ."DEF:'gpu_mem_used'='${rrd_dir}/gpu3_mem_used.rrd':'sum':AVERAGE "
