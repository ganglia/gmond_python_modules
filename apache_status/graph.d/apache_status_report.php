...
function graph_apache_status_report ( &$rrdtool_graph ) {
  ...
  # Unique colors
  $color_array = array("#3366FF"      ,"#33FF66"   ,"#BB9933"           ,"#FF3366"         ,"#FFFF00"     ,"#00FF00"      ,"#AA0000"   , "#FFFFAA"  ,"#FF33CC"    ,"#FF0000"          ,"#CC0000");
  $metric_array = array("ap_open_slot","ap_waiting","ap_reading_request","ap_sending_reply","ap_keepalive","ap_dns_lookup","ap_logging","ap_closing","ap_starting","ap_gracefully_fin","ap_idle");
